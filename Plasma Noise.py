...
class Script(scripts.Script):
    ...
    def ui(self, is_img2img):
        with gr.Accordion('Plasma Noise', open=False):
            ...
            noise_seed = gr.Textbox(label="Noise Seed", lines=1, value="69", elem_id=self.elem_id("noise_seed"))
        ...
        return [enabled, turbulence, noise_seed, denoising, noise_mult]

    def process(self, p, enabled, turbulence, noise_seed, denoising, noise_mult):
        if not enabled:
            return None
